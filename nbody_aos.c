...
//
void move_particles2(particle_t *p, const f32 dt, u64 n)
{
  //
  const f32 softening = 1e-20;
...
int main(int argc, char **argv)
{
  ...
  //
  particle_t *p = malloc(1 * sizeof(particle_t));
  ...
  const u64 s = sizeof(particle_t) + (6 * n * sizeof(f32));
